...
describe('Test de Prueba para Cliente de Infotec', () =>{ 
  ...
  it('Demo completo  -> p1', () =>{
    cy.Bloque_Reto_Form("Juan","Perez","carlos@gmail.com","5548748965","dirección uno","México","Alabama","07989","demo.com","Proyecto demo uno",tiempo)
    cy.wait(tiempo)
  })

  it('Prueba invalida por nombre  Vacio  -> p2', () =>{
    cy.Bloque_Reto_Form("Alberto","Perez","carlos@gmail.com","5548748965","dirección uno","México","Alabama","07989","demo.com","Proyecto demo uno",tiempo)
    cy.wait(tiempo)
  })
  

  it('Prueba invalida por nombre  -> p3', () =>{
  ...
  it('Prueba invalida por nombre con numeros  -> p4', () =>{
    cy.Bloque_Reto_Form("Ro345","Perez","carlos@gmail.com","5548748965","dirección uno","México","Alabama","07989","demo.com","Proyecto demo uno",tiempo)
    cy.wait(tiempo)
  })

  it('Prueba invalida por nombre con simbolos  -> p5', () =>{
    cy.Bloque_Reto_Form("Ro$%#$%#","Perez","carlos@gmail.com","5548748965","dirección uno","México","Alabama","07989","demo.com","Proyecto demo uno",tiempo)
    cy.wait(tiempo)  
  })
  ...
  it('Prueba validar email Vacio  -> p7', () =>{
    cy.Bloque_Reto_Form("Carlos","Perez","carlos.com","5548748965","dirección uno","México","Alabama","07989","demo.com","Proyecto demo uno",tiempo)
  })

  it('Prueba validar email Correcto  -> p8', () =>{
  ...
  it('Prueba invalida por Apellido  -> p9', () =>{
  ...
  it('Prueba invalida por Apellido Vacio -> p10', () =>{
  ...
  it('Prueba datos Correctos.  -> p11', () =>{
    cy.Bloque_Reto_Form("Carlos","Perez","carlos@gmail.com","5548748965","dirección uno","México","Alabama","07989","demo.com","Proyecto demo uno",tiempo)
  })

  it('Prueba carga json  -> p12', () =>{
